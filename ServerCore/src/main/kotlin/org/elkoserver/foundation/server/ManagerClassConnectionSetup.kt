...
internal class ManagerClassConnectionSetup(label: String?, private val mgrClass: String, override var serverAddress: String, auth: AuthDesc, secure: Boolean, props: ElkoProperties, propRoot: String, private val myNetworkManager: NetworkManager, private val actorFactory: MessageHandlerFactory, trServer: Trace, tr: Trace, traceFactory: TraceFactory)
