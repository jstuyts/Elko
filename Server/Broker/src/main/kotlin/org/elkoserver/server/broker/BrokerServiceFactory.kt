 ...
 */
internal class BrokerServiceFactory(private val broker: Broker, private val tr: Trace, private val traceFactory: TraceFactory) : ServiceFactory {
    override fun provideFactory(label: String,
        ...
        return BrokerActorFactory(broker, auth, allowAdmin, allowClient, tr, traceFactory)
    }
}
