...
internal class DirectorServerOgd(provided: Provided, configuration: ObjectGraphConfiguration = ObjectGraphConfiguration()) : ObjectGraphDefinition(configuration) {
    interface Provided {
    ...
    val directorServerSgd = add(DirectorServerSgd(object : DirectorServerSgd.Provided {
