...
class AdminHandler extends BasicProtocolHandler {
        ...
        throws MessageHandlerException
    {
        ...
        int numContexts = 0;
        int numUsers = 0;
        List<ProviderDump> providerList = new LinkedList<>();
     ...
     * OpenContext objects.
     */
    private static JSONLiteralArray encodeContexts(Iterable<OpenContext> contexts) {
     ...
     */
    private static JSONLiteralArray encodeEncodableList(
     ...
     */
    private static JSONLiteralArray encodeProviders(Set<Provider> providers) {
        JSONLiteralArray array = new JSONLiteralArray();
     ...
     */
    private static JSONLiteralArray encodeStrings(Collection<String> strings) {
        JSONLiteralArray array = new JSONLiteralArray();
