...
class Director {
    ...
    Director(Server server, Trace appTrace, TraceFactory traceFactory, Clock clock) {
        ...
        myContextCloneSets = new HashMapMulti<>();
        myUserCloneSets = new HashMapMulti<>();
        myUsers = new HashMapMulti<>();
        myProviders = new TreeMap<>();
        myProviderLimit =
        ...
        myWatchedContexts = new HashMapMulti<>();
        myWatchedUsers = new HashMapMulti<>();

        amShuttingDown = false;
        server.registerShutdownWatcher(() -> {
            amShuttingDown = true;
            LinkedList<Provider> doomedProviders =
                    new LinkedList<>(myProviders.keySet());
            myProviders.clear();
     ...
     */
    private void noteWatchedContext(String contextName) {
     ...
     */
    private void noteWatchedUser(String userName) {
