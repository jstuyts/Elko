...
import org.elkoserver.server.context.DirectorActor
...
internal constructor(
     ...
     */
    fun activate(
        ref: String, subID: String, isEphemeral: Boolean,
        contextor: ContextorProtocol, runner: Executor, loadedFromRef: String,
    ...
    fun enterContext(who: User): String? {
        ...
        return if (isRestricted && !who.entryEnabled(myRef!!)) {
            ...
            sendContextDescription(who, assertActivated(ContextorProtocol::session))
            noteUserArrival(who)
