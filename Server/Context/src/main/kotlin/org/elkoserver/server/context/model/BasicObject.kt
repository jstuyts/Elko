...
import org.elkoserver.server.context.model.Contents.Companion.withContents
import org.elkoserver.server.context.model.Contents.Companion.withoutContents
import org.elkoserver.server.context.model.ModSet.Companion.withMod
...
abstract class BasicObject internal constructor(
    myName: String?, mods: Array<Mod>?, isContainer: Boolean, contents: Array<Item>?
) : DefaultDispatchTarget, DispatchTarget, Encodable, MessageRetargeter, Referenceable {
    ...
    private var myContextor: ContextorProtocol? = null
     ...
     */
    fun activate(ref: String, subID: String, isEphemeral: Boolean, contextor: ContextorProtocol, gorgel: Gorgel) {
        myRef = ref
        myGorgel = gorgel
        if (isEphemeral) {
            markAsEphemeral()
     ...
     */
    fun contextor(): ContextorProtocol = assertActivated { it }
    ...
    protected fun <TResult> assertActivated(myContextorConsumer: (ContextorProtocol) -> TResult): TResult =
