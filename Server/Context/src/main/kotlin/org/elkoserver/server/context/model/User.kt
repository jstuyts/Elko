...
import org.elkoserver.server.context.msgExit
 ...
 */
class User(name: String?, mods: Array<Mod>?, contents: Array<Item>?, ref: String?) :
    BasicObject(name, mods, true, contents), Deliverer {
    ...
    private lateinit var myActor: UserActorProtocol
    ...
    internal constructor(
        ...
        contents: Array<Item>?,
        ref: OptString
    ) : this(name.valueOrNull(), mods, contents, ref.valueOrNull())
     ...
     */
    fun activate(
        ref: String, subID: String, contextor: ContextorProtocol, name: String,
        theSess: String?, isEphemeral: Boolean, isAnonymous: Boolean,
        actor: UserActorProtocol, gorgel: Gorgel
    ) {
    ...
    fun enterContext(context: Context): String? {
        ...
        return if (problem == null) {
            ...
            objectIsComplete()
            assertActivated(ContextorProtocol::notifyPendingObjectCompletionWatchers)
    ...
    fun observePresenceChange(
        observerRef: String?, domain: String?,
