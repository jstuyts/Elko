...
class Item : BasicObject {
    ...
    internal constructor(
        name: String, isContainer: Boolean, isDeletable: Boolean,
        isClosed: Boolean
    ...
    internal constructor(
        name: String, ref: OptString, mods: Array<Mod>, contents: Array<Item>, `in`: OptString,
        isPossibleContainer: OptBoolean, isDeletable: OptBoolean,
        isPortable: OptBoolean, isClosed: OptBoolean
