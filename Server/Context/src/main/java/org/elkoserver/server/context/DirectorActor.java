...
class DirectorActor extends NonRoutingActor {
    ...
    private class RelayIterator {
        private int myMode;
        private static final int MODE_CONTEXT = 1;
        private static final int MODE_USER = 2;
        private static final int MODE_USER_IN_CONTEXT = 3;
        ...
        throws MessageHandlerException
    {
        ...
        /* Must copy lists of dead users and contexts to avert
           ...
           context.forceClose(). */
        List<User> deadUsers = new LinkedList<>();
        List<Context> deadContexts = new LinkedList<>();
