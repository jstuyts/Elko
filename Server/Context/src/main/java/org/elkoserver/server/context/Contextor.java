...
public class Contextor extends RefTable {
    ...
    private Contextor(ObjDB odb, Server server, Trace appTrace) {
        ...
        myContexts = new HashSet<>();
        myContextClones = new HashMapMulti<>();
        myUsers = new HashSet<>();
        myDirectorGroup = null;
        myPresencerGroup = null;
        myUserNames = new HashMap<>();
        myContextNames = new HashMap<>();
        myPendingObjectCompletionWatchers = null;
        initializeContextFamilies();
        myPendingGets = new HashMap<>();
        myStaticObjects = new HashMap<>();
        ...
        server.registerShutdownWatcher(() -> {
            ...
            List<User> saveUsers = new LinkedList<>(myUsers);
     ...
     */
    private Context findContextClone(String ref) {
