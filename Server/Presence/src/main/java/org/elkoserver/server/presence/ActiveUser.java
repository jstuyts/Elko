...
class ActiveUser {
     ...
     *    available.
     */
    private boolean graphsAreReady() {
     ...
     * @param master  The presence server master instance.
     */
    private void notifyFriendsAboutMe(boolean on, String userContext,
     ...
     * @param master  The presence server master instance.
     */
    private void notifyMeAboutFriends(String userContext, PresenceServer master) {
                                 ...
                                 PresenceServer master)
    {
        if (myFriendsByDomain == null) {
            ...
            myFriendsByDomain = new ArrayList<>(count);
