...
class Token {
    ...
    private static final int CLOSE_BRACE   =  2; // The '}' character
    static final int OPEN_BRACE    =  3; // The '{' character
    private static final int CLOSE_BRACKET =  4; // The ']' character
    static final int OPEN_BRACKET  =  5; // The '[' character
    private static final int COLON         =  6; // The ':' character
    private static final int COMMA         =  7; // The ',' character
    private static final int EOF           =  8; // End of input marker
