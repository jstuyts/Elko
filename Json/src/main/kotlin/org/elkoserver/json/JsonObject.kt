...
class JsonObject {
    ...
    override fun toString() =
            JsonObjectSerialization.literal(this, EncodeControl.forRepository).sendableString()
    ...
    fun getString(key: String?, defaultValue: String?) = impl.getString(key, defaultValue)
