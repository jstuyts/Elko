...
(function (root, factory) {
    if (typeof define === 'function' && define.amd) {
        ...
        define(['exports', 'elko-connection'], factory);
    } else if (typeof exports === 'object' && typeof exports.nodeName !== 'string') {
        // CommonJS
        factory(exports, require('elko-connection'));
    } else {
        // Browser globals
        factory((root.elkoSession = {}), root.elkoConnection);
    }
}(typeof self !== 'undefined' ? self : this, function (exports, elkoConnection) {
        ...
        */
        ...
        const mySession = {
            ...
            connect: function (root) {
                myConnection =
                    elkoConnection.connection(root, handleMessage, handleError);
            },
            ...
            if (desc.mods) {
                ...
                for (i = 0; i < desc.mods.length; ++i) {
                    ...
                    if (modType) {
                        ...
                        mod.object = result;
                        for (let p in modType.prototype) {
