...
public class BankClient extends AdminObject implements Consumer<Object> {
     ...
     */
    abstract static class BankReplyHandler {
        /**
     ...
     */
    public abstract static class AccountResultHandler
        extends BankReplyHandler
    {
         ...
         */
        public abstract void result(String account);
    }
     ...
     * (make accounts).
     */
    public abstract static class AccountsResultHandler
        extends BankReplyHandler
    {
        /**
         ...
         */
        public abstract void result(String[] accounts);
    }
     ...
     */
    public abstract static class BalanceResultHandler
        extends BankReplyHandler
    {
        /**
     ...
     */
    public abstract static class CurrencyResultHandler
        extends BankReplyHandler
    {
        /**
         ...
         */
        public abstract void result(String currency);
    }

    /**
     * Result handler class for the encumber request.
     */
    public abstract static class EncumberResultHandler
        extends BankReplyHandler
    {
        /**
     ...
     */
    public abstract static class KeyResultHandler extends BankReplyHandler {
        /**
         * Handle a key result.
         *
     ...
     */
    public abstract static class QueryAccountsResultHandler
        extends BankReplyHandler
    {
        /**
         ...
         */
        public abstract void result(AccountDesc[] accounts);
    }

    /**
     * Result handler class for the query currencies request.
     */
    public abstract static class QueryCurrenciesResultHandler
        extends BankReplyHandler
    {
        /**
     ...
     */
    public abstract static class QueryEncumbranceResultHandler
        extends BankReplyHandler
    {
        /**
         ...
         */
        public abstract void result(String enc, String currency,
     ...
     */
    public abstract static class ReleaseResultHandler
        extends BankReplyHandler
    {
        /**
     ...
     * transferEncumbrance).
     */
    public abstract static class TransferResultHandler
        extends BankReplyHandler
    {
        /**
         ...
         */
        public abstract void result(String src, int srcbal, String dst,
                                    int dstbal);
    }
