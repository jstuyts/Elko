...
public class Cryptor {
    ...
    private SecretKey decodeKey(String keyStr) {
        byte[] encodedKey = base64Decoder.decode(keyStr);
    ...
    public String decrypt(String str) throws IOException {
        ...
        try {
            byte[] iv = base64Decoder.decode(ivStr);
            IvParameterSpec ivSpec = new IvParameterSpec(iv);
            myCipher.init(Cipher.DECRYPT_MODE, myKey, ivSpec);
            return new String(myCipher.doFinal(base64Decoder.decode(cypherText)),
    ...
    public String encrypt(String str) {
        ...
        try {
            ...
            return base64Encoder.encodeToString(iv).substring(0, 22) +
                    base64Encoder.encodeToString(myCipher.doFinal(str.getBytes(StandardCharsets.UTF_8)));
