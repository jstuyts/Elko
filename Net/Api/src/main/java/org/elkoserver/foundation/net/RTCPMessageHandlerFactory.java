...
class RTCPMessageHandlerFactory implements MessageHandlerFactory {
    ...
    private static final int DEFAULT_SESSION_INACTIVITY_TIMEOUT = 60;

    /** Default disconnected timeout if none is explicitly given, in secs. */
    private static final int DEFAULT_SESSION_DISCONNECTED_TIMEOUT = 30;
     ...
     */
    private String makeResumeReply(String sessionID, int seqNum) {
     ...
     */
    private String makeStartReply(String sessionID) {
