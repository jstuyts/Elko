...
class HttpConnectionSetupFactory(
    ...
    override fun create(label: String?, host: String, auth: AuthDesc, secure: Boolean, propRoot: String, actorFactory: MessageHandlerFactory) =
            HttpConnectionSetup(label, host, auth, secure, props, propRoot, httpServerFactory, actorFactory, baseConnectionSetupGorgel, listenerGorgel, jsonHttpFramerCommGorgel, traceFactory, mustSendDebugReplies)
}
