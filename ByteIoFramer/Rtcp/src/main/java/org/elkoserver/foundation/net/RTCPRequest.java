...
class RTCPRequest {
    ...
    private static final int STATE_AWAITING_VERB = 0;
    private static final int STATE_AWAITING_MESSAGE = 1;
    private static final int STATE_COMPLETE = 2;

    /** RTCP request verb */
    private int myVerb;

    public static final int VERB_START = 0;
    public static final int VERB_RESUME = 1;
    public static final int VERB_ACK = 2;
    public static final int VERB_MESSAGE = 3;
    public static final int VERB_END = 4;
    public static final int VERB_ERROR = 6;
    ...
    private static final Pattern theDelimiterPattern = Pattern.compile(" +");
    ...
    void addMessage(Object message) {
        ...
        if (myMessage == null) {
            ...
            if (myOtherMessages == null) {
                myOtherMessages = new LinkedList<>();
            }
