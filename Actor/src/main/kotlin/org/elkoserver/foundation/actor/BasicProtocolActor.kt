...
/**
 * Interface to be implemented by actor classes making use of the [ ] message handler implementation, or handlers derived
 * from it.  The [BasicProtocolHandler] requires the methods defined in
 * this interface to be available to it as callbacks on the Actor for whom it
 * is providing services.
 */
interface BasicProtocolActor : Deliverer {
    /**
