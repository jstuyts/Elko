...
public class Runner implements Runnable {
     ...
     * time to exit.
     */
    private static int theRunnerCount = 0;

    /**
     * DANGER DANGER: Mutable static.
     */
    private static Runner theDefaultRunner = null;

    /**
     * The number of Runnables to dequeue and run in one go.
     * Must be >= 1.
     */
    private static final int DEQUEUE_GRANULARITY = 25;
     ...
     */
    private void waitForMore() throws InterruptedException {
        myNotifyLock.wait();
    }
}
